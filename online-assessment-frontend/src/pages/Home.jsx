...
export default function Home() {
  return (
    <div className="max-h bg-gradient-to-bl from-indigo-900 via-blue-800 to-purple-900 text-white flex flex-col items-center justify-center px-4 sm:px-6 lg:px-6 p-5">
      {/* Hero Section */}
      ...
      <p>© 2026 Online Assessment System | Developed by Vishal Kumar Singh</p>
    </div>
  );
}
